...
class BatdongsanSpider(scrapy.Spider):
    ...
    start_urls = (
        ...
        'http://batdongsan.com.vn/du-an-bat-dong-san',
    )
    ...
    def parse_property(self, response):
        ...
        contact_mobile = response.css(
            "div#LeftMainContent__productDetail_contactMobile div.right::text").extract_first()
        ...
        contact_email = response.css(
            "div#LeftMainContent0e05fc061426e8ce153b00323aad41525656ab3b__productDetail_contactEmail div.right::text").extract_first()
        contact_address = response.css(
            "div#LeftMainContent__productDetail_contactAddress div.right::text").extract_first()
        contact_info = {
